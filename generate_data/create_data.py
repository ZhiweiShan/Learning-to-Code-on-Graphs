...
if __name__ == "__main__":
    ...
    p_bi = 0.3 # p is the probability that an edge exists,
    q_bi = 0.3 # q is the probability that an edge is demanded
    #random HH bipartite
    num_nodes_HH = 30
    max_degree_HH = 8
    q_HH = 0.2
    ...
    m_ba=7
    #random network
    num_t, num_antenna, p_network = 8, 1, 0.4
    num_r = num_t
    #random PA_graph
    num_nodes_pre = 30
    max_degree_pre = 6
    ...
    if graph_type == 'random_bigraph':
        base_data_dir = os.path.join('data/data_di_bipar_{}{}{}{}_{}_1000test'
        ...
        base_data_dir = os.path.join('data/data_di_network_{}{}{}{}_{}_test'
